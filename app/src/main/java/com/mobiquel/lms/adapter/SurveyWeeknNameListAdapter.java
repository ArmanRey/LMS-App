...
public class SurveyWeeknNameListAdapter extends RecyclerView.Adapter<SurveyWeeknNameListAdapter.OptionsViewHolder> {

    private Context context;
    private List<CourseNameModel> optionsList;

    public SurveyWeeknNameListAdapter(List<CourseNameModel> optionsList) {
